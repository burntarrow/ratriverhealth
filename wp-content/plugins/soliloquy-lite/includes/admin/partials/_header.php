...
if ( $notifications_count > 0 ) {
	$data_count = absint( $notifications_count );
}
?>
...
<div id="soliloquy-header">
	...
	<div class="soliloquy-right">
		<a type="button" id="soliloquy-notifications-button" class="soliloquy-button-just-icon soliloquy-notifications-inbox soliloquy-open-notifications" data-dismissed="<?php echo esc_attr( $dismissed_count ); ?>" <?php echo $data_count > 0 ? 'data-count="' . esc_attr( $data_count ) . '"' : ''; ?>>
