...
/* Custom Widgets Declaration */
function rat_river_widgets_init() {

    register_sidebar( array(
            'name' => 'St-Pierre Hospital Foundation',
            'id' => 'donate_now_banner_foundation',
            'before_widget' => '',
            'after_widget' => '',
            'before_title' => '',
            'after_title' => '',
...
add_action( 'widgets_init', 'rat_river_widgets_init' );
